...
export default function ProfilePage() {
  ...
  if (loading || !profile) return <div className="p-8 text-center text-gray-800 dark:text-gray-200">Loading...</div>;
  ...
  return (
    <div className="max-w-8xl bg-[#eaf9ff] dark:bg-gray-900 mx-auto p-6 min-h-screen">
      ...
      >
        <div>
          <p className="font-medium text-gray-800 dark:text-white">Enrolled Courses</p>
      ...
      <div className="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow dark:shadow-gray-900/50 p-4">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-3">Streak</h2>
        <StreakGrid />
      </div>
